...
function getProduct() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, apiSimulator_1.fetchProductCatalog)()
                        .then(function (data) {
                        console.log(data);
                    })
                        .catch(function (err) {
                        ...
                        else if (err instanceof errors_1.DataError) {
...
function productReport(params) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, apiSimulator_1.fetchProductReviews)(params)
                        .then(function (res) {
                        console.log(res);
                    })
                        .catch(function (err) {
                        ...
                        .finally(function () {
                        console.log("Get data by ID api is complete.");
                        console.log('\n ');
                    })];
                case 1:
                    _a.sent();
